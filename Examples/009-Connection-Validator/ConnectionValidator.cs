...
public static class ConnectionValidator
{
    ...
    public static void Main()
    {
        ...
        client1.Connected += () => Console.WriteLine("Client 1 successfully connected!");
        client1.ConnectFailed += () => Console.WriteLine("Client 1 failed to connect...");
        
        client2.Connected += () => Console.WriteLine("Client 2 successfully connected!");
        client2.ConnectFailed += () => Console.WriteLine("Client 2 failed to connect...");
        
        client3.Connected += () => Console.WriteLine("Client 3 successfully connected!");
        client3.ConnectFailed += () => Console.WriteLine("Client 3 failed to connect...");
